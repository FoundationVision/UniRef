...
def parse_args():
    ...
    parser.add_argument("--data_root", default="datasets/davis17/DAVIS", type=str, help="directory of DAVIS")
...
if __name__ == "__main__":
    ...
    output_json = os.path.join(data_root, "davis%s_%s.json"%(year, split))
