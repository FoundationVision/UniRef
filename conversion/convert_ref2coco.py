...
def parse_args():
    ...
    parser.add_argument("--src_json", default="datasets/coco2014/annotations/refcoco-unc/instances.json", type=str, help="the original json file")
    parser.add_argument("--des_json", default="datasets/coco2014/annotations/refcoco-unc/instances.json", type=str, help="the processed json file")
