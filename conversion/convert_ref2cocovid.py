...
def parse_args():
    ...
    parser.add_argument("--src_json", default="datasets/coco2014/annotations/refcoco-mixed/instances_train.json", type=str, help="")
    parser.add_argument("--des_json", default="datasets/coco2014/annotations/refcoco-mixed/instances_train_video.json", type=str, help="")
